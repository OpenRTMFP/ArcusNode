 ...
 *
 * @param {Buffer} buffer The Buffer the packet will work on
 * @param {integer} size Can be smaller than the buffer length, tells how many bytes have been written to the packet already
 */
