...
RTMFP_VALID_MARKERS = [0x8d, 0x8e, 0x8a, 0x0d, 0x0b, 0x89, 0x09, 0x49, 0x4e, 0x4a, 0x0e, 0x0a];
    ...
    switch(type)
    {
      ...
      case 0x11 :
        ...
        if(message.flow == 0x02)
        {
          ...
          switch(message.commandName) {
            ...
            case 'setPeerInfo':
              ...
              //TODO: read AMF0 strings and handle as addresses outside
              message.addresses = [];
        ...
        else if(message.flow > 0x02 && message.stage == 0x01)
        {
          ...
          console.log('DEBUG GROUP MESSAGE: ', message, gidLength, clippedPkt.toString(), clippedPkt.pos);
