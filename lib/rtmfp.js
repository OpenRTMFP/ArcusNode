...
module.exports = function(settings){
  ...
  //TODO: make and keep stateless, no instance, specifiy those settings in the request (message) in setResponse (writePacket)
  var _settings = {
    serverKeepalive: 60,
    clientKeepalive: 60
  };
  ...
  //TODO: use native buffer write hex functionality instead of packet
