    ...
    switch(type)
    {
      ...
      case 0x11 :
        ...
        if(sequence == 0x02)
        {
          ...
          pkt.skip(1);
          request.messageName = pkt.readBytes(pkt.readInt16(), true).toString('ascii')
          request.messageData = {};
          console.log('Message Name: ', request.messageName);
          ...
          switch(request.messageName) {
            ...
            default:
              ...
              console.log('Unhandled Message: ' + request.messageName);
              break;
          }
