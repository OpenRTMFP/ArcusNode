...
module.exports = function(settings){
  ...
  this.readMessage = function(pkt, lastMessage){
    ...
    switch(type)
    {
      ...
      //
      case 0x38:
        message = { type: types.HANDSHAKE_2 };
      ...
      //
      case 0x41 :
        message = { type: types.KEEPALIVE_RESPONSE };
        break;
      ...
      case 0x0c:
      case 0x4c:
        message = { type: types.NET_CONNECTION_CLOSE };
        break;
      ...
      case 0x51:
        ...
        message = { type: (ackMarker == 0x7f) ? types.ACK : types.NOT_ACK };
      ...
      //
      case 0x5e:
        message = { type: types.UNKNOWN_0x5e };
      ...
      case 0x11 :
        ...
        if(message.sequence == 0x02)
        {
          ...
          switch(message.commandName) {
            ...
            case 'connect':
              message.type = types.NET_CONNECTION_OPEN;
              //Read AMF Data
            ...
            case 'setPeerInfo':
              message.type = types.NET_CONNECTION_ADDRESSES;
        ...
        {
          message.type = types.NET_GROUP_JOIN;
        ...
        {
          message.type = types.NET_GROUP_LEAVE;
        }
  ...
  this.writePacket = function(pkt, message){
    ...
    switch(message.type)
    {
      ...
      case types.COMMAND_ERROR:
        ...
        AMF0.writeString(pkt, (message.type === types.COMMAND_RESULT) ? '_result' : '_error');
        AMF0.writeNumber(pkt, message.commandHandle);
        
        //AMF0 NULL MARKER to close header
        AMF0.writeNull(pkt);
                    
        if(message.type === types.COMMAND_RESULT) {
        ...
        } else if(message.type === types.COMMAND_ERROR) {
...
types.COMMAND = 0x0F;
types.COMMAND_RESULT = 0x10;
types.COMMAND_ERROR = 0x11;
types.FORWARD = 0x12;
module.exports.MESSAGE_TYPE = types;
