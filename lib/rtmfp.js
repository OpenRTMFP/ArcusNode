  ...
  this.writePacket = function(pkt, message){
    ...
    switch(message.type)
    {
      ...
      case RTMFP.RENDEZVOUZ_NEWCOMER:
        pkt.writeInt8(RTMFP_MARKER_RESPONSE_2);
        pkt.writeInt16(_timeNow());
        pkt.writeInt8(0x0f);
        ...
        if(!(message.peerId instanceof Buffer) || message.peerId.length != 32){
          throw new Error('Peer id for newcomer request has to be 32 bytes.');
        }
