  ...
  this.writePacket = function(pkt, message){
    ...
    switch(message.type)
    {
      ...
      case RTMFP.NET_CONNECTION_REQUEST:
        ...
        pkt.writeInt8(RTMFP_MARKER_MESSAGE_4); //No echo time for now
        pkt.writeInt16(_timeNow());
        pkt.writeInt8(0x10);
        ...
        pkt.writeBytes([0x05, 0x00, 0x54, 0x53, 0x04, 0x00, 0x00, 0x14, 0x00, 0x00, 0x00, 0x00]); //hardcoded header
        
        AMF0.writeString(pkt, 'connect'); //commandName
        AMF0.writeNumber(pkt, 10); //commandHandle
